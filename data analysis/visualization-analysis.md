**RQ C.b: "How do cycling infrastructure conditions including road pavement types and geospatial locations (inside or outside built-up areas), influence the number of cycling incidents in Amsterdam?**

![alt text](Cycling_Incidents_by_Netherlands_province.png)
This study focuses on Amsterdam because preliminary analysis revealed it has the highest incidence of cycling accidents among Dutch districts, with over 30,000 recorded incidents, significantly surpassing other regions. This prevalence makes it a critical case study for urban cycling infrastructure challenges.
